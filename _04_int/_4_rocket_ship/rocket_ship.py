...
def mouse_pressed(event):
    ...
    canvas.create_oval(x - 300,y + 100,x + 300,y + 500, fill= 'red')
    canvas.create_oval(x - 150, y + 100, x + 150, y + 325, fill= 'yellow')
    canvas.create_oval(x - 75, y  + 100, x + 75, y + 75, fill= 'orange')
